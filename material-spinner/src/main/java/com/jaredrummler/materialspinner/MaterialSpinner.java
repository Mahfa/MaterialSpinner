...
//      }
        ...
        int dimen_4d = Utils.convertDP2PX(getContext(),4);
        ...
        listView.setPadding(dimen_4d,dimen_4d,dimen_4d,dimen_4d);
        ...
        try
        {
            ...
            method.invoke(scrollBar, Utils.getDrawable(getContext() , R.drawable.ms__scrollbar_indicator));
        }
        catch(Exception e)
        {
            e.printStackTrace();
...
//                }
        ...
        popupWindow.setAnimationStyle(R.style.Animation_Window_Popup);


        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            popupWindow.setElevation(dimen_4d);
    ...
    public <T> void setItems(@NonNull List<T> items) {
        ...
        adapter = new MaterialSpinnerAdapter<>(getContext(), items)
                .setTextColor(textColor).setTypeface(getTypeface());
...
//        } else {
            ...
            int x = location[0];
            int y = location[1]-Utils.convertDP2PX(getContext(),4);
